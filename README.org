...
*Org-mode for scripts and AI agents.* Query and mutate org files from the command line. Parses headlines, TODOs, tags, timestamps, properties, clock entries, links --- no Emacs required.

[[https://dotnet.microsoft.com/][https://img.shields.io/badge/.NET-9.0-512BD4?logo=dotnet&style=flat]] [[https://github.com/dcprevere/org-cli/releases/latest][https://img.shields.io/github/v/release/dcprevere/org-cli?label=org-cli&style=flat]]
...
This repo ships two [[https://github.com/openclaw/openclaw][OpenClaw]] plugins that put =org= in front of an AI agent:
...
See [[file:integrations/openclaw/README.md][integrations/openclaw/README.md]] for an overview, or each plugin's README for install and env var details.
